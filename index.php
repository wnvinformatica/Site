...
<head>
  ...
  <meta name="description" content="WNV Informática - Software Programação">
  <meta name="author" content="WNV Informática" />
  <!-- SITE TITLE -->
...
<body>
  ...
  <!-- <div id="customizer" class="hidden-xs">
    <div class="options"><i class="nc-icon-outline pc"></i></div>
    <span>HEADERS</span>
    <ul id="headerbg">
      <li>
        <a href="/demo1" >Dashboard - Particles</a>
      </li>
      <li>
        <a href="/demo2" >Mobile - Particles</a>
      </li>
      <li>
        <a href="/demo3">Subscribe - Particles</a>
      </li>
      <li>
        <a href="/demo4">Dashboard - Video</a>
      </li>
      <li>
        <a href="/demo5" class="active">Mobile - Video</a>
      </li>
      <li>
        <a href="/demo6">Subscribe - Video</a>
      </li>
      <li>
        <a href="/demo7">Dashboard - Image</a>
      </li>
      <li>
        <a href="/demo8">Mobile - Image</a>
      </li>
      <li>
        <a href="/demo9">Subscribe - Image</a>
      </li>
      <li>
        <a href="/demo10">Video & Form - Particles</a>
      </li>
      <li>
        <a href="/demo11">Video & Form - Video</a>
      </li>
      <li>
        <a href="/demo12">Video & Form - Image</a>
      </li>
    </ul>
    <span>COLORS</span>
    <ul id="colors">
      ...
      <span>SUPPORT</span>
      <li>
        <a target="_blank" href="http://keysoft.keydesign-themes.com/documentation/">Documentation</a>
      </li>
      <li>
        <a target="_blank" href="http://keydesign.ticksy.com">Submit a Ticket</a>
      </li>
    </ul>
  </div>  -->
  <!-- MAIN NAV -->
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="main-menu">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li>
            <a class="page-scroll" href="#video">Programas</a>
          </li>
          <li>
  ...
  <header id="header">
    <div class="container">
      ...
      <div class="header-dashboard">
        <img src="img/mockups/mobile.png" class="dashboard" alt="">
      </div>
    </div>
    ...
    <div class="container">
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="item active" style="width:100%; height:70vh;">
            <div style="padding:2rem;">1</div>
            <div class="carousel-caption">
              DOWNLOAD
            </div>
          </div>

          <div class="item" style="width:100%; height:70vh;">
            <div style="padding:2rem;">2</div>
            <div class="carousel-caption">
              DOWNLOAD
            </div>
          </div>
...
<section id="clients" class="gray-bg">
  <div class="container">
    <div class="slider">
      <center><div class="clients-content">
        <!-- TEla de Login -->
        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><font color="RED">Login</font> <span class="caret"></span></a>
                  <ul class="dropdown-menu">
                    <from>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="lower-footer">
        <div class="pull-left">
          <span>© 2017 WNV Informática. Todos os direitos reservados </span>
